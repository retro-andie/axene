...
void
png_read_data(png_ptr, data, length)  png_structp png_ptr; png_bytep data; png_uint_32 length;
{
...
static void
png_default_read_data(png_ptr, data, length)  png_structp png_ptr; png_bytep data; png_uint_32 length;
{
   png_uint_32 check;
...
void
png_set_read_fn(png_ptr, io_ptr, read_data_fn)  png_structp png_ptr; png_voidp io_ptr;
