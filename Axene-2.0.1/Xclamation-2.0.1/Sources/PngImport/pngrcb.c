...
void
png_read_IHDR(png_ptr, info, width, height, bit_depth, color_type, compression_type, filter_type, interlace_type)
png_structp png_ptr;
png_infop info;
png_uint_32 width;
png_uint_32 height;
...
void
png_read_sBIT(png_ptr, info, sig_bit)
png_structp png_ptr;
png_infop info;
...
void
png_read_cHRM(png_ptr, info, white_x, white_y, red_x, red_y, green_x, green_y, blue_x, blue_y)
png_structp png_ptr;
png_infop info;
double white_x;
double white_y;
...
void
png_read_tRNS(png_ptr, info, trans, num_trans, trans_values) 
png_structp png_ptr;
png_infop info;
png_bytep trans;
int num_trans;
...
void
png_read_bKGD(png_ptr, info, background)
png_structp png_ptr;
png_infop info;
...
void
png_read_hIST(png_ptr, info, hist)
png_structp png_ptr;
png_infop info;
png_uint_16p hist;
{
...
void
png_read_zTXt(png_ptr, info, key, text, text_len, compression)
png_structp png_ptr;
png_infop info;
png_charp key;
png_charp text;
...
void
png_read_tEXt(png_ptr, info, key, text, text_len)
png_structp png_ptr;
png_infop info;
png_charp key;
png_charp text;
