/*
** Pager.h for Xclamation in Pager/
**
...
** Last update Wed Oct 21 19:31:08 1998 Emmanuel Paris
*/
...
typedef struct
{
  ...
  void	(*Draw)();
  void	(*EventLook)();
  void	(*SelectPage) ___PROTO((c_Pager *This, listpage *Page));
} sf_Pager;
...
struct sc_Pager
{
 ...
 int		nb_page;
 listpage	*list_page;
 listpage	*selected_page;
 int		nb_page_visible;
 int		first_page_pos;
 listpage	*first_page_visible;
 int		last_page_pos;
 listpage	*last_page_visible;
 listpage	*page_number_display;
