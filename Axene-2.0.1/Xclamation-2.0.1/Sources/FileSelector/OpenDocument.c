/*
** OpenDocument.c for Xclamation in FileSelector/
...
** Last update Mon Jan 23 17:04:45 1995 Robin Castanier
*/
...
Widget w;
{
  ...
  F(OpenDocumentSelector).addPattern(OpenDocumentSelector, TRUE, "*.xc");
  return TRUE;
}
