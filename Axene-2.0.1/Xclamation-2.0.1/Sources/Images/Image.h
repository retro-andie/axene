/*
** Image.h for Xclamation in Images/
...
** Last update Fri Oct  9 20:20:48 1998 Emmanuel Paris
*/
...
#include "CadreStd.h"
#include "Colormap.h"
#include "Zoom_Mode_And_Reinit.h"
...
struct sc_Image
{
  ...
  c_Colormap	*colormap;   /* object colormap */
  Display	*display;	
  ...
  boolean	image_calc; 	/* TRUE if image already caculated */
  boolean	can_display;	/* TRUE if image can be displayed */
