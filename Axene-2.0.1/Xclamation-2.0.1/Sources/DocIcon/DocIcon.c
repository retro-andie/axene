/*
** DocIcon.c for Xclamation, XQuad, XAllWrite, XMayday and AxeneOffice in 
** 	DocIcon/
...
** Last update Sun Jan 11 15:42:49 1998 Emmanuel Paris
*/
...
Display	*display;
{
 ...
 memset(This->icon_Doc, 0, sizeof(Pixmap) * NB_ICON_DOCUMENT);
