#ifndef lint
static char rcsid[] = "$Header: /usr/people/sam/tiff/libtiff/RCS/tif_dirinfo.c,v 1.25 93/08/25 09:20:24 sam Exp $";
#endif
...
/* end SGI tags */
 ...
 TIFFFieldInfo *
TIFFFindFieldInfo(tag, dt)
ttag_t tag;
TIFFDataType dt;
{
	static  TIFFFieldInfo *last = NULL;
