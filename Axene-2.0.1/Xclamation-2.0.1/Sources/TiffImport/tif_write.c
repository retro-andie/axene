#ifndef lint
static char rcsid[] = "$Header: /usr/people/sam/tiff/libtiff/RCS/tif_write.c,v 1.54 93/08/26 14:27:58 sam Exp $";
#endif
...
static	int TIFFWriteCheck ___PROTO((TIFF*, int,  char*));
static	int TIFFBufferSetup ___PROTO((TIFF*,  char*));
static	int TIFFGrowStrips ___PROTO((TIFF*, int,  char*));
static	int TIFFAppendToStrip ___PROTO((TIFF*, tstrip_t, tidata_t, tsize_t));
static	int TIFFSetupStrips ___PROTO((TIFF*));
