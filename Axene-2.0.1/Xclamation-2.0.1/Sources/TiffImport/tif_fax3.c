#ifndef lint
static char rcsid[] = "$Header: /usr/people/sam/tiff/libtiff/RCS/tif_fax3.c,v 1.75 93/08/26 14:24:43 sam Exp $";
#endif
...
static	int Fax3Decode1DRow ___PROTO((TIFF*, u_char*, int));
static	int Fax3Encode1DRow ___PROTO((TIFF*, u_char*, int));
static	int findspan ___PROTO((u_char**, int, int, u_char*));
static	int finddiff ___PROTO((u_char*, int, int, int));
