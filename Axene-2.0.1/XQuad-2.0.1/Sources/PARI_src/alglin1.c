...
GEN b;
{
  ...
  else
  {
	...
	m=gsub(m,gmul(gcoeff(aa,i,j),(GEN)x[j]));
      av4=avma;
      x[i]=lpile(av3,av4,gdiv(m,gcoeff(aa,i,i)));
    }
  }
...
int
compte(mat, row, longueur, firstnonzero)
long **mat;
long row;
long longueur;
long *firstnonzero;
...
int
compte2(mat, row, longueur, firstone)
long **mat;
long row;
long longueur;
long *firstone;
...
GEN
hnfspec(mat, ptpdep, ptmatc, vperm, ptmatalpha, co, li, k0, ptnlze, ptcol)
long** mat;
GEN* ptpdep;
GEN* ptmatc;long* vperm;GEN* ptmatalpha;long co;long li;long k0;long* ptnlze;long* ptcol;
{
...
GEN
hnffinal(matgen, ptpdep, ptmatc, vperm, ptmatalpha, lnz, co, li, col, lig, nlze, ptcol)
GEN matgen;
GEN* ptpdep;
GEN* ptmatc;long* vperm;GEN* ptmatalpha;long lnz;long co;long li;long col;long lig;long nlze;long* ptcol;
{
...
GEN
hnfadd(mit, ptpdep, ptmatc, vperm, ptmatalpha, co, li, col, ptnlze, extramat, extramatc)
GEN mit;
GEN* ptpdep;
GEN* ptmatc;long* vperm;GEN* ptmatalpha;long co;long li;long col;long* ptnlze;GEN extramat;GEN extramatc;
{
