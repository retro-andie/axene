char *helpmessage[] =
{
  ...
  "factberl(x,p)=factorization mod p of the polynomial x using Berlekamp",
  "factfq(x,p,a)=factorization of the polynomial x in the finite field\nF_p[X]/a(X)F_p[X]",
  "factmod(x,p)=factorization mod p of the polynomial x using Cantor-Zassenhaus",
  ...
  "initalgred2(P)=P being a nonconstant irreducible polynomial, gives the\npolymod mod(a,pol) equal to mod(x,P) where pol is as in initalgred",
  ...
  "polredabs(x)=smallest generating polynomial of the number field for the T2\nnorm on the roots",
  ...
  "sumalt(X=a,expr)=Villegas's acceleration of alternating series expr,\nX starting at a",
  "sumalt2(X=a,expr)=Euler-Van Wijngarten's acceleration of alternating series\nexpr, X starting at a",
