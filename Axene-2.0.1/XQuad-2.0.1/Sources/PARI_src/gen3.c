...
GEN x;
GEN y;
 { return gegal(x,y) ? gun : gzero;}
GEN
gne(x, y)
GEN x;
GEN y; 
{ return gegal(x,y) ? gzero : gun;}
GEN
gand(x, y)
GEN x;
GEN y;
{ return gcmp0(x) ? gzero : (gcmp0(y) ? gzero : gun);}
GEN
gor(x, y)
GEN x;
GEN y;
{ return gcmp0(x) ? (gcmp0(y) ? gzero : gun) : gun;}
