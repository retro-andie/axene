/*
** Cursor_OFFICE.h for AxeneOffice in Cursor/
**
...
** Last update Mon Jan 12 13:31:26 1998 Robin Castanier
*/

#ifndef _Cursor_OFFICE_
#define _Cursor_OFFICE_
...
#undef NB_CURSOR
#define	NB_CURSOR LAST_CURSOR_OFFICE
