/*
** Set_New_Priority.c for XAllWrite in FrameManager/
**
...
** Last update Tue Jun 30 17:32:52 1998 Emmanuel Paris
*/
...
c_FrMg	*cfrmg;
{
 ...
 while(lcadre)
 {
  lcadre->priority = F(cfrmg).get_priority_cadre(cfrmg, lcadre);
  F(cfrmg).lower_priority(cfrmg, lcadre);
  lcadre = lcadre->NextCadre;
 }
 free_list_cadre(svglcadre, NO_DEL_CADRE);
}

void set_higher_priority(cfrmg)
c_FrMg	*cfrmg;
{
 l_Cadre	*lcadre;
 l_Cadre	*svglcadre;
 ...
 {
  lcadre->priority = F(cfrmg).get_priority_cadre(cfrmg, lcadre);
  F(cfrmg).higher_priority(cfrmg, lcadre);
  lcadre = lcadre->NextCadre;
 }
...
void set_lowest_priority(cfrmg)
c_FrMg	*cfrmg;
{
 l_Cadre	*lcadre;
 l_Cadre	*svglcadre;
 ...
 {
  lcadre->priority = F(cfrmg).get_priority_cadre(cfrmg,lcadre);
  F(cfrmg).lowest_priority(cfrmg,lcadre);
  lcadre = lcadre->NextCadre;
 }
 free_list_cadre(svglcadre,NO_DEL_CADRE);
}

void set_highest_priority(cfrmg)
c_FrMg	*cfrmg;
{
 l_Cadre	*lcadre;
 l_Cadre	*svglcadre;
 ...
 {
  lcadre->priority = F(cfrmg).get_priority_cadre(cfrmg,lcadre);
  F(cfrmg).highest_priority(cfrmg,lcadre);
  lcadre = lcadre->NextCadre;
 }
 free_list_cadre(svglcadre,NO_DEL_CADRE);
}
...
l_Cadre *lcadre;
{
 ...
 if ((lowcadre->cadre->textflow_mode & XcTFM_HOLE_MASK) == XcTFM_OVER)
...
l_Cadre *lcadre;
{
 ...
 if (lcadre->priority!=max_prior-1)
 {
  ...
  if ((lcadre->cadre->textflow_mode & XcTFM_HOLE_MASK) == XcTFM_OVER)
   This->redraw_polygone_callback(This->callback_data, total, FALSE);
