...
struct xobject {
       ...
       int16_t references;    /* count of pointers to this object
...
#define XOBJ_COMMON      char type; unsigned char flag; int16_t references;
...
extern int16_t CRASTERCompressionType   INITIALIZED(1);
...
extern int16_t CachedChars   INITIALIZED(0x7FFF);
extern int16_t CachedFonts   INITIALIZED(0x7FFF);
