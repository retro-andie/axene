/*
** ImportStd.h for XAllWrite in Global/
...
** Last update Mon Aug 10 14:12:16 1998 Emmanuel Paris
*/
...
error	(*load) ___PROTO((void *This, c_Document *doc));
/* load document, document is already created  */
#endif
...
#define IMPORT_CREATE_NEW_DOCUMENT(obj) \
((c_Import_Std *)(obj))->f->create_new_document
