/*
** global_defs.h for XInstall in Global/
** Global definitions
**
...
** Last update Sat Jan 15 16:54:37 2000 Emmanuel Paris
*/
...
defined(___hpux10) ||defined(___sun5_x86) || defined(___sun4) || \
defined(___linux_glibc)
#define vfork fork
#endif
...
#define WITH_ZPM
#define XC_STREAM
#define Xc_NO_UNIT		/* no unit in textfields */
#define SHORT int

/*--- Constants ---*/
#define Xc_ENVIRONNEMENT "XINSTALL_LIB"
#define Xc_ENVIRONNEMENT_GLOBAL "AXENE_LIB"
#define Xc_SOFTWARE_NAME "XInstall"
#define Xc_XINSTALL
