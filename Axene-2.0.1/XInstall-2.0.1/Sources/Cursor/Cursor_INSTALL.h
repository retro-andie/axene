/*
** Cursor_INSTALL.h for XInstall in Cursor/
**
...
** Last update Fri Jul  4 15:10:16 1997 Emmanuel Paris
*/

#ifndef _Cursor_INSTALL_
#define _Cursor_INSTALL_
...
#undef NB_CURSOR
#define	NB_CURSOR LAST_CURSOR_INSTALL
