/*
** Actions.c for XInstall in MainInterface/
...
** Last update Sun Aug 15 00:12:12 1999 Emmanuel Paris
*/
...
int	*nargs;
{
...
#ifdef LESSTIF_VERSION
 {
  if ( XtHasCallbacks(w, XmNmodifyVerifyCallback) == XtCallbackHasSome)
  {
   ...
   cbs.currInsert = cbs.newInsert = cbs.startPos = cbs.endPos = tpos;
   cbs.text = &text;
   
   printf("before: %s\n", args[0]);
   text.ptr = args[0];
   text.length = strlen(args[0]);
   text.format = XmFMT_8_BIT;

   XtCallCallbacks(w, XmNmodifyVerifyCallback, &cbs);
  }
 }
#endif
 Xc_free(dups);
...
{
 
};
