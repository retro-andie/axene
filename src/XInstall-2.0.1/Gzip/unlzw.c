...
**
** Started on  Sometime during     1997 One of the authors
** Last update Fri Aug 29 13:53:59 1997 One of the authors
*/
...
#if defined(___i386_linux) || defined(___sparc_linux)
