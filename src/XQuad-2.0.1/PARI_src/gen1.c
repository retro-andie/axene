...
GEN y;
{
  ...
  long  tetpil,l1,a1,a2,r1,r2,d,r,l2,co;
  GEN z,p1,p2,p3,p4,p;
  ...
  if (ty<10)
  {
	...
	case 7 :
	  ...
	  {
	    z=cgetg(5,7);z[2]=(long)copyifstack(p);
	    l=avma;p1=addii((GEN)x[4],(GEN)y[4]);
	    r=r1;if(r2<r1) {r=r2;p2=x;x=y;y=p2;}
	    if(gcmp0(p1)||((co=pvaluation(p1,p,&p2))>=r))
	    {
	      avma=l;z[1]=evalvalp(e+r);z[3]=un;
