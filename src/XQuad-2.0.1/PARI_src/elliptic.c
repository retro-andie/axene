...
static int aux ___PROTO((GEN ak, int p, int l)),aux2 ___PROTO((GEN ak, int p, GEN pl)),numroots2 ___PROTO((int a, int b, int c, int p, int *mult)),numroots3 ___PROTO((int a, int b, int c, int p, int *mult));
...
GEN pl;
{
  ...
  for(;;)
  {
    ...
    qsort(table, s, sizeof(multiple), (int (*) ___PROTO((void *, void *)))compare_multiples);
...
static void cumule ___PROTO((GEN *vtotal, GEN *e, GEN u, GEN r, GEN s, GEN t)), cumule1 ___PROTO((GEN *vtotal, GEN *e, GEN v2));
