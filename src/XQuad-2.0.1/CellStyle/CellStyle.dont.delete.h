/*
** CellStyle.dont.delete.h for XQuad in CellStyle/
...
** Last update Fri Apr 21 14:15:36 1995 Emmanuel Paris
*/
...
{ 
  int			used_times;	/* nb cells that use this style */
...
typedef struct
{
  ...
  CellStyle_t *(*AddCellStyleToBase) ___PROTO((c_CellStyle *This,
					       CellStyle_t *cell_style));
  void (*RemoveCellStyleToBase) ___PROTO((c_CellStyle *This,
					  CellStyle_t *cell_style));
  void (*DisplayCellStyle) ___PROTO((c_CellStyle *This, 
				     CellStyle_t *cell_style, 
  ...
  boolean (*readList) ___PROTO((c_DocFile *doc, char *keyword,
				long param, void *data));
  boolean (*write) ___PROTO((c_CellStyle *this, c_DocFile *doc));
...
#define NB_CELL_PATTERN 43
#define CELL_PATTERN_DATA_NUM 4

int	CPLine1Def[] = { 1, 1};
int	CPLine2Def[] = { 2};
int	CPLine3Def[] = { 1, 1, 1};
int	CPLine4Def[] = { 2, 1, 1};

CellPatternLineStyle_t	CPLine[] = {
  { CPLine1Def, PNULL, PNULL, PNULL, PNULL},
  { CPLine2Def, PNULL, PNULL, PNULL, PNULL},
  { CPLine3Def, PNULL, PNULL, PNULL, PNULL},
  { CPLine4Def, PNULL, PNULL, PNULL, PNULL} };
