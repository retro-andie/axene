/*
** global_defs.h for XQuad in Global/
** Global definitions
**
...
** Last update Sat Jan  8 15:35:28 2000 Emmanuel Paris
*/
...
extern double atof ___PROTO((const char *string));
...
typedef GEN cellvalue2_t;
typedef real cellvalue_t;
...
struct _region_t 
{
  ...
  int	y_min;
  int	y_max;
  struct _region_t	*NextRegion;
};

#define Xc_DUMP_REGION(str, regionp) \
  Xc_TRACE(("%s: %d->%d, %d->%d", (str), (regionp)->x_min, (regionp)->x_max, \
	    (regionp)->y_min, (regionp)->y_max)) 
...
#ifndef __GNUC__
#if defined(___alpha) || defined(___iris4d) || defined(___sco386) ||\
defined(___i386_unixware) || defined(___sco386sV) || defined (___hpux10)||\
 defined(___hpux9) || defined(___rs6000)
extern int rand();
#else
...
#if defined(___sco386) || defined(___sco386sV) || defined(___i386_unixware) ||\
defined(___hpux9) || defined(___sun5_x86)
#define gethostid() 0
#endif
...
/*--- Constants ---*/
#define Xc_ENVIRONNEMENT "XQUAD_LIB"
#define Xc_ENVIRONNEMENT_GLOBAL "AXENE_LIB"
#define Xc_SOFTWARE_NAME "XQuad"
#define Xc_XQUAD

#define XqMAX_PRECISION 20
#define XqMAX_DT_SEQ	20
/* row and column exception definition */
#define COLUMN_MAX	701
#define ROW_MAX		99999

#define SCROLLB_H_AREA	20
#define SCROLLB_V_AREA	50

#define Xq_FORMULA_LENGTH 4000
#define Xc_COPYRIGHT_BEGIN 1995
#define Xc_COPYRIGHT_END 2000
#endif
