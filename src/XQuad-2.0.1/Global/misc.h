...
** Last update Mon Jun 23 18:41:07 1997 One of the authors
*/
...
defined(___i386_unixware) || defined(___sco386sV)) && !defined(STDLIB_NOT_EXIST) 
# include <string.h>
# include <stdlib.h>
#else
...
extern region_t *strtoreg ___PROTO((char *string));
extern void colrowtostr ___PROTO((int column, int row, char *str));
extern boolean strtocolrow ___PROTO((char *string, int *column, int *row));
extern void coltostr ___PROTO((int column, int *lng, char *str));
extern boolean strtocol ___PROTO((char *string, int *column));
