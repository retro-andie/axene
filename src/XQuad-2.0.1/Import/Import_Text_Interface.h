/*
** Import_Text_Interface.h for XQuad in Import/
...
** Last update Tue Nov 14 15:14:12 1995 Emmanuel Paris
*/
...
typedef struct {
  ...
  Widget	sep1;
  c_RadioBox	*rbFSITtrim;
  Widget	sep2;
  c_Label	*lFSITseparators;
  c_WTextField	*tfFSITseparators;
  Widget	sep3;
