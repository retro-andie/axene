/*
** CommandLine.h for XQuad in MainInterface/
...
** Last update Mon Aug  7 18:51:42 2000 Emmanuel Paris
*/

static char helpDisplay[] = "\
usage:   XQuad [-help] [-version] [-fg <color>] [-bg <color>]\n\
...
\n\
";
static char copyrightDisplay[] = "Copyright 1995-2000 Axene.";
