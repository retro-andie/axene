/*
** CommandLine.h for XMayday in MainInterface/
...
** Last update Mon Aug  7 18:52:08 2000 Emmanuel Paris
*/

static char helpDisplay[] = "\
usage:   XMayday [-help] [-version] [-fg <color>] [-bg <color>]\n\
         [-display <displayname>] [-geometry <geom>] [-/+ownColormap]\n\
         [-keepFreeColor <number>] [-index <file>] [file]\n\
\n\
detail:\n\
...
static char copyrightDisplay[] = "Copyright 1996-2000 Axene.";
