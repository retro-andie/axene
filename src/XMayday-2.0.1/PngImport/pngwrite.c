...
void
png_write_info(png_ptr, info)  png_structp png_ptr; png_infop info;
{
...
void
png_write_end(png_ptr, info)  png_structp png_ptr; png_infop info;
{
...
#if defined(PNG_WRITE_tIME_SUPPORTED)
void
png_convert_from_struct_tm(ptime, ttime)  png_timep ptime; struct tm FAR * ttime;
{
...
void
png_convert_from_time_t(ptime, ttime)  png_timep ptime; time_t ttime;
{
   struct tm *tbuf;
...
png_structp
png_create_write_struct(user_png_ver, error_ptr, warn_fn, error_fn)  png_const_charp user_png_ver; voidp error_ptr;
...
/* initialize png structure, and allocate any memory needed */
void
png_write_init(png_ptr)  png_structp png_ptr;
{
...
void
png_write_rows(png_ptr, row, num_rows)  png_structp png_ptr; png_bytepp row;
...
void
png_write_image(png_ptr, image)  png_structp png_ptr; png_bytepp image;
{
...
void
png_write_row(png_ptr, row)  png_structp png_ptr; png_bytep row;
{
...
void
png_set_flush(png_ptr, nrows)  png_structp png_ptr; int nrows;
{
...
void
png_write_flush(png_ptr)  png_structp png_ptr;
{
   int wrote_IDAT;
...
void
png_destroy_write_struct(png_ptr, info_ptr)  png_structpp png_ptr; png_infopp info_ptr;
{
...
void
png_write_destroy(png_ptr)  png_structp png_ptr;
{
...
void
png_set_filter(png_ptr, method, filters)  png_structp png_ptr; int method; int filters;
{
...
void
png_set_compression_level(png_ptr, level)  png_structp png_ptr; int level;
{
...
void
png_set_compression_mem_level(png_ptr, mem_level)  png_structp png_ptr; int mem_level;
{
...
void
png_set_compression_strategy(png_ptr, strategy)  png_structp png_ptr; int strategy;
{
...
void
png_set_compression_window_bits(png_ptr, window_bits)  png_structp png_ptr; int window_bits;
{
   if (window_bits > 15)
...
void
png_set_compression_method(png_ptr, method)  png_structp png_ptr; int method;
{
   if (method != 8)
