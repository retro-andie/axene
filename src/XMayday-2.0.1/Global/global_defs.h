/*
** global_defs.h for XMayday in Global/
** Global definitions
**
...
#if defined(___m88k) || defined(___sun4) || defined(___sun5) || defined(___hpux10) || defined(___hpux9)
typedef float real;
#else
typedef double real;
#endif
...
defined(___sco386sV) || defined(___hpux10) || defined(___hpux9) ||\
defined(___rs6000) || defined(___i386_unixware) 
extern int rand();
#else
...
/*--- Constants ---*/
#define Xc_ENVIRONNEMENT "XMAYDAY_LIB"
#define Xc_ENVIRONNEMENT_GLOBAL "AXENE_LIB"
#define Xc_SOFTWARE_NAME "XMayday"
#define Xc_XMAYDAY

#define Xc_COPYRIGHT_BEGIN 1996
