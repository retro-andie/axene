...
extern void HTMLViewClearAndRefresh();
extern void HTMLGetScrollPos();
extern void HTMLSetScrollPos();
extern char *HTMLGetTitle();
extern void HTMLAddHRef();
#else
...
extern void HTMLViewClearAndRefresh(Widget w);
extern void HTMLGetScrollPos(Widget hw, int *vx, int *vy);
extern void HTMLSetScrollPos(Widget hw, int vx, int vy);
extern char *HTMLGetTitle(Widget hw);
extern void HTMLAddHRef(Widget hw, char *anchor);
#endif /* _NO_PROTO */
...
typedef struct pcall_rec
{
  XEvent *event;
  int element_id;
  char *href;
} WbpointerMotionCallbackData;
...
typedef struct table_field
{
  ...
  int		request_width;	/* positive: in pixel, negative: in percent */
  int		request_height;	/* positive: in pixel, negative: in percent */
  int		maxWidth;
  int		minWidth;
  int		maxHeight;
  int		minHeight;
  ...
  Boolean	nowrap;	       /* enable/disable wrap */
  boolean	background;    /* TRUE if special background color */
  unsigned long	bgcolor;       /* background color */
  
  struct ele_rec *first_rec;
  struct ele_rec *last_rec;  
} TableField;

typedef struct table_rec
{
  int		borders;	/* border thickness */
  char		*caption;
  int		captionAlignment;	/* ALIGN_TOP or ALIGN_BOTTOM */
  XFontStruct	*captionFont;
  boolean	background;
...
#define ALIGN_TOP       2
#define VALIGN_MASK	3

#define ALIGN_LEFT	0
#define ALIGN_CENTER	4
#define ALIGN_RIGHT	8
#define HALIGN_MASK	12
...
#define M_FRAME		57
/* tags added by Xibios 2 from Axene */
#define M_BIG		58
#define M_SMALL		59
#define M_LEFT		60
#define M_CENTER	61
...
#define WbNextraData             "extraData"
#define WbNbigFont		 "bigFont"
#define WbNsmallFont		 "smallFont"
...
#define WbCExtraData		 "ExtraData"
#define WbCBigFont		 "BigFont"
#define WbCSmallFont		 "SmallFont"
