/*
** RegisterHelp.h for AxeneOffice in VoidHeaders/
** register help is not used in AxeneOffice nor XInstall
...
** Last update Tue Jan 20 18:13:05 1998 Robin Castanier
*/

#ifndef _RegisterHelp_h
#define _RegisterHelp_h

#define NO_REGISTER_HELP
