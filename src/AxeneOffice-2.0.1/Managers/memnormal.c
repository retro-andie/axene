/*
** memnormal.c for Xclamation, XQuad, XAllWrite, XMayday, XInstall and 
...
** Last update Fri Feb  9 18:06:16 1996 Emmanuel Paris
*/
...
void *slots;
{
  void **current= (void **)slots;
  void **next= (void **)((char *)current + size);
