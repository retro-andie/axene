...
void
png_write_data(png_ptr, data, length)  png_structp png_ptr; png_bytep data; png_uint_32 length;
{
...
static void
png_default_write_data(png_ptr, data, length)  png_structp png_ptr; png_bytep data; png_uint_32 length;
{
   png_uint_32 check;
...
void
png_flush(png_ptr)  png_structp png_ptr;
{
...
static void
png_default_flush(png_ptr)  png_structp png_ptr;
{
...
void
png_set_write_fn(png_ptr, io_ptr, write_data_fn, output_flush_fn)  png_structp png_ptr; png_voidp io_ptr;
