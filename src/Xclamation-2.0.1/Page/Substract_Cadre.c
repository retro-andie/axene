/*
** Substract_Cadre.c for Xclamation in Page/
**
...
**
** Started on  Mon Jul 17 19:51:38 1995 Emmanuel Paris
** Last update Thu Oct 24 16:17:09 1996 Emmanuel Paris
*/


#include "Page.h"

void substract_cadre(cpage)
   c_Page	*cpage;
{
  l_Cadre	*lcadre;
  l_Cadre	*svglcadre;
