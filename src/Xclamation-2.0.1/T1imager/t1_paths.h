...
#include "t1_port.h" 
#define   Loc(S,x,y)                   t1_Loc(S,(real_t)x,(real_t)y)
...
#define   Conic(B,C,s)                 t1_Conic(B,C,(real_t)s)
#define   RoundConic(M,C,r)            t1_RoundConic(M,C,(real_t)r)
#define   ArcP3(S,P2,P3)               t1_ArcP3(S,P2,P3)
#define   ArcCA(S,C,d)                 t1_ArcCA(S,C,(real_t)d)
...
real_t t1_Hypoteneuse();      /* returns the length of a line                 */
