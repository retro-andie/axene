/*
** CloseDocument.c for Xclamation in FileSelector/
...
** Last update Mon Jan 23 17:04:31 1995 Robin Castanier
*/
...
Widget w;
{
  ...
  F(CloseDocumentSelector).addPattern(CloseDocumentSelector, TRUE, "*.xc");
  return TRUE;
}
