/*
** config.h for Xclamation in Main/
...
** Last update Fri Apr 14 19:15:28 1995 Emmanuel Paris
*/
...
#define Xc_USER_CONFIG_FILE ".xclamationrc"
#define Xc_CONFIG_FILE "xclamationrc"
