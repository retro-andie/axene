#ifndef lint
static char rcsid[] = "$Header: /usr/people/sam/tiff/libtiff/RCS/tif_open.c,v 1.43 93/08/26 14:25:21 sam Exp $";
#endif
...
TIFF*
TIFFClientOpen(name, mode, clientdata, readproc, writeproc, seekproc, closeproc, sizeproc, mapproc, unmapproc)
     char* name;
     char* mode;
...
{
	static  char module[] = "TIFFClientOpen";
	TIFF *tif;
	int m, bigendian;
