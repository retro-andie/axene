...
typedef	void  (*TIFFVoidMethod) ___PROTO((TIFF*));
typedef	int (*TIFFBoolMethod) ___PROTO((TIFF*));
typedef	int (*TIFFCodeMethod) ___PROTO((TIFF*, tidata_t, tsize_t, tsample_t));
typedef	int (*TIFFSeekMethod) ___PROTO((TIFF*, uint32));
typedef	void (*TIFFPostMethod) ___PROTO((TIFF*, tidata_t, tsize_t));
...
#define	TIFF_POSTENCODE		0x200	/* need call to postencode routine */
	...
	TIFFHeader	tif_header;	/* file's header block */
	 int*	tif_typeshift;	/* data type shift counts */
	 long*	tif_typemask;	/* data type masks */
...
#define	ReadOK(tif, buf, size) \
	(TIFFReadFile(tif, (tdata_t) buf, (tsize_t) (size)) == (int)(size))
#endif
#ifndef SeekOK
...
extern "C" {
#endif
extern	void* _TIFFmalloc ___PROTO((size_t));
extern	void* _TIFFrealloc ___PROTO((void*, size_t));
extern	void _TIFFfree ___PROTO((void*));
...
extern	int TIFFNoRowDecode ___PROTO((TIFF*, tidata_t, tsize_t, tsample_t));
extern	int TIFFNoStripDecode ___PROTO((TIFF*, tidata_t, tsize_t, tsample_t));
extern	int TIFFNoTileDecode ___PROTO((TIFF*, tidata_t, tsize_t, tsample_t));
extern	void TIFFNoPostDecode ___PROTO((TIFF*, tidata_t, tsize_t));
extern	void TIFFSwab16BitData ___PROTO((TIFF*, tidata_t, tsize_t));
extern	void TIFFSwab32BitData ___PROTO((TIFF*, tidata_t, tsize_t));
extern	int TIFFFlushData1 ___PROTO((TIFF*));
extern	void TIFFFreeDirectory ___PROTO((TIFF*));
extern	int TIFFDefaultDirectory ___PROTO((TIFF*));
extern	int TIFFSetCompressionScheme ___PROTO((TIFF *, int));

extern	int TIFFInitDumpMode ___PROTO((TIFF*));
#ifdef PACKBITS_SUPPORT
extern	int TIFFInitPackBits ___PROTO((TIFF*));
#endif
#ifdef CCITT_SUPPORT
extern	int TIFFInitCCITTRLE ___PROTO((TIFF*)), TIFFInitCCITTRLEW ___PROTO((TIFF*));
extern	int TIFFInitCCITTFax3 ___PROTO((TIFF*)), TIFFInitCCITTFax4 ___PROTO((TIFF*));
#endif
#ifdef THUNDER_SUPPORT
extern	int TIFFInitThunderScan ___PROTO((TIFF*));
#endif
#ifdef NEXT_SUPPORT
extern	int TIFFInitNeXT ___PROTO((TIFF*));
#endif
#ifdef LZW_SUPPORT
extern	int TIFFInitLZW ___PROTO((TIFF*));
#endif
#ifdef JPEG_SUPPORT
extern	int TIFFInitJPEG ___PROTO((TIFF*));
#endif
#if defined(__cplusplus)
}
#endif
