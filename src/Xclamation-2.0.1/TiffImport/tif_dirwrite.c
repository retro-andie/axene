#ifndef lint
static char rcsid[] = "$Header: /usr/people/sam/tiff/libtiff/RCS/tif_dirwrite.c,v 1.31 93/08/26 14:24:07 sam Exp $";
#endif
...
static	int TIFFWriteNormalTag ___PROTO((TIFF*, TIFFDirEntry*,  TIFFFieldInfo*));
static	void TIFFSetupShortLong ___PROTO((TIFF*, ttag_t, TIFFDirEntry*, uint32));
static	int TIFFSetupShortPair ___PROTO((TIFF*, ttag_t, TIFFDirEntry*));
static	int TIFFWriteRational ___PROTO((TIFF*,
					TIFFDataType, ttag_t, TIFFDirEntry*, float));
static	int TIFFWritePerSampleShorts ___PROTO((TIFF*, ttag_t, TIFFDirEntry*));
static	int TIFFWriteShortTable ___PROTO((TIFF*, ttag_t, TIFFDirEntry*, uint32, uint16**));
static	int TIFFWriteShortArray ___PROTO((TIFF*,
					  TIFFDataType, ttag_t, TIFFDirEntry*, uint32, uint16*));
static	int TIFFWriteLongArray ___PROTO((TIFF *,
					 TIFFDataType, ttag_t, TIFFDirEntry*, uint32, uint32*));
static	int TIFFWriteRationalArray ___PROTO((TIFF *,
					     TIFFDataType, ttag_t, TIFFDirEntry*, uint32, float*));
static	int TIFFWriteFloatArray ___PROTO((TIFF *,
					  TIFFDataType, ttag_t, TIFFDirEntry*, uint32, float*));
static	int TIFFWriteString ___PROTO((TIFF*, ttag_t, TIFFDirEntry*, char*));
#ifdef JPEG_SUPPORT
static	int TIFFWriteJPEGQTables ___PROTO((TIFF*, TIFFDirEntry*));
static	int TIFFWriteJPEGCTables ___PROTO((TIFF*, ttag_t, TIFFDirEntry*, u_char**));
#endif
#ifdef COLORIMETRY_SUPPORT
static	int TIFFWriteTransferFunction ___PROTO((TIFF*, TIFFDirEntry*));
#endif
static	int TIFFWriteData ___PROTO((TIFF*, TIFFDirEntry*, char*));
static	int TIFFLinkDirectory ___PROTO((TIFF*));
...
*/
static int TIFFWriteNormalTag(tif, dir, fip)
TIFF* tif;
TIFFDirEntry* dir;
TIFFFieldInfo* fip;
{
...
*/
static void
TIFFSetupShortLong(tif, tag, dir, v)
TIFF* tif;
ttag_t tag;
TIFFDirEntry* dir;
uint32 v;
...
*/
static int
TIFFWriteRational(tif, type, tag, dir, v)
TIFF* tif;
TIFFDataType type;
ttag_t tag;
TIFFDirEntry* dir;
...
*/
static int
TIFFWritePerSampleShorts(tif, tag, dir)
TIFF* tif;
ttag_t tag;
TIFFDirEntry* dir;
{
...
*/
static int
TIFFSetupShortPair(tif, tag, dir)
TIFF* tif;
ttag_t tag;
TIFFDirEntry* dir;
{
...
*/
static int
TIFFWriteShortTable(tif, tag, dir, n, table)
TIFF* tif;
ttag_t tag;
TIFFDirEntry* dir;
uint32 n;
...
*/
static int
TIFFWriteString(tif, tag, dir, cp)
TIFF* tif;
ttag_t tag;
TIFFDirEntry* dir;
char* cp;
...
*/
static int
TIFFWriteShortArray(tif, type, tag, dir, n, v)
TIFF* tif;
TIFFDataType type;
ttag_t tag;
TIFFDirEntry* dir;
...
*/
static int
TIFFWriteLongArray(tif, type, tag, dir, n, v)
TIFF* tif;
TIFFDataType type;
ttag_t tag;
TIFFDirEntry* dir;
...
*/
static int
TIFFWriteRationalArray(tif, type, tag, dir, n, v)
TIFF* tif;
TIFFDataType type;
ttag_t tag;
TIFFDirEntry* dir;
...
static int
TIFFWriteFloatArray(tif, type, tag, dir, n, v)
TIFF* tif;
TIFFDataType type;
ttag_t tag;
TIFFDirEntry* dir;
...
*/
static int
TIFFWriteJPEGCTables(tif, tag, dir, tab)
TIFF* tif;
ttag_t tag;
TIFFDirEntry* dir;
u_char** tab;
...
#ifdef COLORIMETRY_SUPPORT
static int
TIFFWriteTransferFunction(tif, dir)
TIFF* tif;
TIFFDirEntry* dir;
{
 TIFFDirectory* td = &tif->tif_dir;
