#ifndef lint
static char rcsid[] = "$Header: /usr/people/sam/tiff/libtiff/RCS/mkg3states.c,v 1.16 93/08/25 09:08:33 sam Exp $";
#endif
/*
...
*
*	Reference: $Id: mkg3states.c,v 1.16 93/08/25 09:08:33 sam Exp $
*
...
void	build_null_mode_tables ___PROTO((void));
short	find_horiz_mode_prefix ___PROTO((long, char));
short	find_null_mode_prefix ___PROTO((long));
short	null_mode_type ___PROTO((long));
void	build_horiz_mode_tables ___PROTO((void));
short	horiz_mode_code_black ___PROTO((short));
short	horiz_mode_code_white ___PROTO((short));
void	build_uncomp_mode_tables ___PROTO((void));
void	write_tables ___PROTO((FILE*,int));
 ...
 if (verbose) 
{
 ...
 write_tables(stdout, witch);
 exit(0);
}

void
write_null_mode_table(fd, table, name)
FILE* fd;
NullModeTable table;
char* name;
{
...
void
write_horiz_mode_table(fd, table, name)
FILE* fd;
...
int witch;
{
 ...
 case 0:
  ...
  write_null_mode_table(fd, uncomp_mode_next_state, 
 ...
 case 1:
  fprintf(fd, "%s\n",
	  "/* DO NOT EDIT THIS FILE, IT WAS AUTOMATICALLY CREATED BY mkg3state -1 */");
  write_preamble(fd);
  extern_table(fd, "TIFFFax2DMode");
  extern_table(fd, "TIFFFax2DNextState");
  extern_table(fd, "TIFFFaxUncompAction");
 ...
 case 2:
  fprintf(fd, "%s\n",
	  "/* DO NOT EDIT THIS FILE, IT WAS AUTOMATICALLY CREATED BY mkg3state -2 */");
 ...
 case 3:
  fprintf(fd, "%s\n",
	  "/* DO NOT EDIT THIS FILE, IT WAS AUTOMATICALLY CREATED BY mkg3state -3 */");
  fprintf(fd, "%s\n", "typedef unsigned char u_char;");
  write_horiz_mode_table(fd, horiz_mode, "TIFFFax1DAction");
  break;
 case 4:
  fprintf(fd, "%s\n",
	  "/* DO NOT EDIT THIS FILE, IT WAS AUTOMATICALLY CREATED BY mkg3state -4 */");
  fprintf(fd, "%s\n", "typedef unsigned char u_char;");
  write_horiz_mode_table(fd, horiz_mode_next_state, "TIFFFax1DNextState");
  break;
 }
...
short
find_horiz_mode_prefix(prefix, color)
long prefix;
char color;
{
 short j1;
 ...
 */
 ...
 if (verbose)
  fprintf(stderr, "\nhoriz mode prefix %d, color %c = 0x%lx ",
	  (int) horiz_mode_prefix_count, "WB"[(int)color], prefix);
...
short
find_uncomp_mode_prefix(prefix)
long prefix;
{
 short j1;
 ...
 */
 ...
 for (prefix = 0; prefix < horiz_mode_prefix_count; prefix++)
  for (byte = 0; byte < 256; byte++) 
  {
   ...
   if (!bits_digested)
   {				/* no codewords after examining byte */
