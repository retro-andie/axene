...
extern	int Fax3Decode2DRow ___PROTO((TIFF*, u_char*, int));
extern	int Fax3Encode2DRow ___PROTO((TIFF*, u_char*, u_char*, int));
extern	void Fax3PutBits ___PROTO((TIFF*, u_int, u_int));
extern	void Fax3PutEOL ___PROTO((TIFF*));
extern	int TIFFInitCCITTFax3 ___PROTO((TIFF*));
