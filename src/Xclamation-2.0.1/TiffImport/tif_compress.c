#ifndef lint
static char rcsid[] = "$Header: /usr/people/sam/tiff/libtiff/RCS/tif_compress.c,v 1.33 93/08/25 09:17:06 sam Exp $";
#endif
...
static  cscheme_t CompressionSchemes[] = {
...
char* method;
{
	 cscheme_t *c = findScheme(tif->tif_dir.td_compression);
