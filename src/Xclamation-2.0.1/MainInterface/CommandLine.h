/*
** CommandLine.h for Xclamation in MainInterface/
...
** Last update Mon Aug  7 18:50:27 2000 Emmanuel Paris
*/

static char helpDisplay[] = "\
usage:   Xclamation [-help] [-version] [-fg <color>] [-bg <color>]\n\
         [-display <displayname>] [-geometry <geom>] [-/+opaqueResize]\n\
         [-opaqueMove <percentage>] [-/+ownColormap] [-keepFreeColor <number>]\n\
         [files ...]\n\
\n\
detail:\n\
...
\n\
";
static char copyrightDisplay[] = "Copyright 1994-2000 Axene.";
