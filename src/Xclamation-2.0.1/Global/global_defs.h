/*
** global_defs.h for Xclamation in Global/
** Global definitions
**
...
defined(___NetBSD) || defined(___freebsd) || defined(___i386_unixware) || \
defined(___ncr_svr4) || defined(___alpha) || defined(___WIN32) || \
defined(___sun5_x86)
...
defined(___sco386sV) || defined(___i386_unixware) || defined(___hpux10) ||\
...
/*--- Constants ---*/
#define Xc_ENVIRONNEMENT "XCLAMATION_LIB"
#define Xc_ENVIRONNEMENT_GLOBAL "AXENE_LIB"
#define Xc_SOFTWARE_NAME "Xclamation"
#define Xc_XCLAMATION
#define Xc_COPYRIGHT_BEGIN 1994
#define Xc_COPYRIGHT_END 2000

#ifndef Xc_REGISTER_LEVEL
#define Xc_REGISTER_LEVEL 0
#endif
