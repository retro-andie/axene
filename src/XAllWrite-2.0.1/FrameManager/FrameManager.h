...
extern sf_frmg_function	fc_Create_Cadre_Elipse;
extern sf_frmg_function	fc_Create_Cadre_Polygonal;
extern sf_frmg_function fc_Insert_Point;
extern sf_frmg_function fc_Delete_Point;
/* extern sf_page_function fc_Select_Move_Resize_Cadre; */
extern sf_frmg_function fc_Dispatch_To_Object;
...
typedef struct
{
  ...
  void		(*get_clip_polygone) ___PROTO((c_FrMg *This, int x, int y,
  ...
  boolean (*ps_print) ___PROTO((c_FrMg *this, c_PostScript *post, 
				boolean *over_clip));
  boolean (*ps_print_over) ___PROTO((c_FrMg *this, c_PostScript *post, 
