...
# 
# Started on  Sun Jan 18 16:33:44 1998 Emmanuel Paris
# Last update Sat Apr  8 16:55:13 2000 Emmanuel Paris
#
...
TestAxeneLauncher()
{
 axnl=`echo $bin_list | sed "s/$name_base/AxeneLauncher/"`
 if [ -x $axnl ]; then
  bin_list=`echo $axnl" "$bin_list`
 fi
}
