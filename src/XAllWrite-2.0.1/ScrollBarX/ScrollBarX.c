/*
** ScrollBarX.c for XAllWrite in ScrollBarX/
**
...
** Last update Wed Oct 21 17:34:16 1998 Emmanuel Paris
*/
...
{
 This->Pos = 0;
 /* hack to force a redraw of central part */
 if (Pos == 0) Pos = -1; 
...
boolean		actif;
{
 ...
 This->Vsize = Vsize;
 This->Hole = Hole;
 This->Csize = MAX(SCROLLC_MINSIZE, This->Bsize * Vsize / This->Rsize);
 This->CPos = This->Bsize * This->Pos / This->Rsize;
 x = orig_x;
 y = orig_y;
...
static void draw_ScrollBarX(This)
c_ScrollBarX	*This;
{
 if (This->Orient==SBVERTICAL)
 {
...
int		y;
{
 ...
 if (This->Orient == SBVERTICAL && Event->type == ButtonPress &&
...
int		NsizeY;
{
 ...
 This->CPos = This->Bsize * This->Pos / This->Rsize;
 This->Csize = MAX(SCROLLC_MINSIZE, This->Bsize * This->Vsize / This->Rsize);

 Xc_TRACE(("Csize: %d Bsize: %d Vsize: %d Rsize: %d", This->Csize,
	   This->Bsize, This->Vsize, This->Rsize));
...
c_ScrollBarX	*This;
{
 ...
 {
  This->Csize = MAX(SCROLLC_MINSIZE, CENTRAL_POS + CENTRAL_SIZE - This->CPos);
